		...
		<div style="display: flex; justify-content: space-between;">
				...
				<a href="./index.php">
					<button id="recalculate-btn" style="margin-top: 50px;" class="roas-calculate-btn" onclick="">
						<i style="padding-right: 10px;" class="fas fa-arrow-left arrow-right"></i>RECALCULATE ROAS
					</button>
				<a>
			
				<a href="#">
					<button style="margin-top: 50px;" class="roas-calculate-btn">SEND ME THESE RESULTS<i style="padding-left: 10px;" class="fas fa-envelope arrow-left"></i></button>
				</a>
		</div>
		</div>
	</div>
